...
function Projects() {
    return (
        <div>
            ...
            <article>
                <h3>Keeper</h3>
                <p>Keeper is a notetaking app with a simple minimalist design and multiple responsive elements. Allowing the user to manipulate each note taking area seperately allows for more ease of use and better organization. 
                This was built built with React using JSX. An express backend with a MongoDB database is in the process of being implemented.</p>
            </article>
            <article>
                <h3>Secrets</h3>
                <p>Ever had a secret nagging at your mind and no way to express it? Well this application helps you doi just that! This app was designed to be a safe place to anonymously share their thoughts and ideas as well as view what other secrets other unknown people may have.
                This app was an exercise using express and mongoose to develop a secure authentication design with a database populated by private users and their passwords. I'm quite pleased with the end result and I definitely learned a lot about designing authentication security which I believe is critically important for users seeking privacy in a world so dependant on a publically online presence.</p>
            </article>
            <article>
                <h4>Simon Says</h4>
